...
print_step "3" "Creating Kubernetes resources"
...
print_step "4" "Applying Istio configurations"
...
print_step "5" "Waiting for resources to be ready"
...
print_step "6" "Getting Istio Ingress Gateway IP"
